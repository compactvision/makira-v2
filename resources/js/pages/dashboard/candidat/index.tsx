        ...
        <AdminLayout title="Liste des candidats">
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 z-40 flex items-center justify-center px-4">
                    {/* Overlay */}
                    <div
                        className="pointer-events-none absolute inset-0 bg-gray-500/75"
                        aria-hidden="true"
                    />
                    ...
                    <div className="relative z-50 w-full max-w-lg transform overflow-hidden rounded-lg bg-white shadow-xl transition-all">
                        ...
                        <div className="flex flex-col-reverse gap-3 bg-gray-50 px-6 py-3 sm:flex-row sm:justify-end">
                            <button
                                onClick={() => setShowDeleteModal(false)}
                                className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
                            >
                                Annuler
                            </button>
                            ...
                            <button
                                ...
                                className="inline-flex justify-center rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none"
                            >
                                Supprimer
                            </button>
                        </div>
